...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <% 
            ...
            if (payment != null) {
                ...
                // Retrieve any form submission error messages
                String errorMessage = (String) request.getAttribute("errorMessage");

                // Retrieve student details for dropdown selection
        ...
        <form action="updatePaymentAction.jsp" method="POST" id="updatePaymentForm">
            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
            <h1 class="display-4 py-2 text-truncate">Edit Payment</h1>
            <div class="px-2">  
            <input type="hidden" name="paymentId" value="<%= paymentId %>">

            <div class="form-group">
                <label for="amount">Amount:</label>
                <input type="text" class="form-control text-center" name="amount" value="<%= amount %>">
            </div>

            <div class="form-group">
                <label for="date">Date:</label>
                <input type="text" class="form-control text-center" name="date" value="<%= date %>">
            </div>

            <div class="form-group">
                <label for="student">Student:</label>
                <select class="form-control text-center" name="student">
                    <% for (Student student : students) { %>
                        <option value="<%= student.getStudentId() %>"
                            <%= student.getStudentId() == studentId ? "selected" : "" %>>
            ...
            <button type="submit" class="btn btn-primary" onclick="confirmUpdate(event)">Update Payment</button>
            </div>
            </div>
        </form>
        ...
        <% 
                ...
                // Payment does not exist, show an error message
