                                 ...
                                 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td><%= room.getHostel().getName() %></td>
                                             <td class="text-center">
                                                 <div class="d-flex justify-content-center">
                                                    <button class="btn btn-primary mr-3" onclick="location.href='edit-room.jsp?roomNumber=<%= room.getRoomNumber() %>'">Edit</button>
                                                    <form method="post" action="delete-room.jsp" class="ml-2 d-inline">
