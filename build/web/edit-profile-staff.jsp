    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Welcome, ${staff.staffName}!</span>
                ...
                <!-- Begin Page Content -->
                <div class="container">
                    <form method="post" action="update-profile-staff">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="staffEmail" name="staffEmail" value="${staff.staffEmail}" required>
                        </div>
                        <div class="form-group">
                            <label for="staffPhone">Phone:</label>
                            <input type="text" class="form-control" id="staffPhone" name="staffPhone" value="${staff.staffPhone}" required>
                        </div>
                        <div class="form-group">
                            <label for="staffDOB">Date of Birth:</label>
                            <input type="date" class="form-control" id="staffDOB" name="staffDOB" value="${staff.staffDOB}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="staffAddress">Address:</label>
                            <input type="text" class="form-control" id="staffAddress" name="staffAddress" value="${staff.staffAddress}" required>
                        </div>
                        <div class="form-group">
                            <label for="password">Password:</label>
                            <input type="password" class="form-control" id="password" name="password" value="${staff.staffPassword}" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Update Profile</button>
                        <a href="staff-dashboard.jsp" class="btn btn-secondary">Back to Dashboard</a>
                    </form>

                    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
                    <%
                        // Check if the successMessage attribute exists
